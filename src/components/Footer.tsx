...
export function Footer({ disclaimer, repoUrl, liveUrl }: FooterProps) {
  return (
    <footer className="relative border-t border-border/60">
      ...
      <div className="relative mx-auto flex w-full max-w-6xl flex-col gap-5 px-5 py-12 sm:flex-row sm:items-end sm:justify-between sm:px-8">
        <div className="max-w-xl">
          <p className="font-display text-base font-semibold">
            Weather<span className="temp-text">Edge</span>
          </p>
          <p className="mt-1 text-sm text-muted">Station-aligned SFO forecasting + prediction-market quant research.</p>
